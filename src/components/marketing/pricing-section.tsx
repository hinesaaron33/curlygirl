      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <RevealDiv delay="delay-200">
            <p className="mx-auto mt-4 max-w-md text-base text-ink/50">Every plan includes a curated lesson bundle plus monthly credits to unlock more.</p>
              ...
              <>
                {tier.highlighted && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                    <span className="rounded-full bg-pink px-6 py-1.5 text-xs font-bold tracking-wider text-white uppercase shadow-lg shadow-pink/25 transition-all duration-300 group-hover:bg-white group-hover:text-pink group-hover:shadow-white/25">{tier.badge}</span>
                  </div>
                )}
